...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Case-Locked Out Account</layout>
    ...
    <layoutAssignments>
        <layout>FeedItem-Vasfam Feed Item Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Feedback__c-Feedback Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Global-Vasfam Test Group Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <objectPermissions>
        ...
        <object>AM_Asset_Allocation__c</object>
